...
const AutomationDashboard = () => {
  ...
  return (
    <div className='automation-dashboard dashboard-container'>
      {/* Header */}
      <div className='automation-header page-header'>
        <h2>🤖 Automation</h2>
        <div className='automation-controls page-controls'>
          <button
      ...
      <div className='automation-content two-column-layout'>
        {/* Automations List */}
